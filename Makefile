...
install: all
	...
	cp -f scripts/dmenu_screenshot.sh ${DESTDIR}${PREFIX}/bin
	cp -f scripts/dmenu_wifi.sh ${DESTDIR}${PREFIX}/bin
	cp -f scripts/dmenu_displayselect.sh ${DESTDIR}${PREFIX}/bin
	...
	chmod 755 ${DESTDIR}${PREFIX}/bin/dmenu_screenshot.sh
	chmod 755 ${DESTDIR}${PREFIX}/bin/dmenu_wifi.sh
	chmod 755 ${DESTDIR}${PREFIX}/bin/dmenu_displayselect.sh
